...
<html>
  <head>
    ...
    <title>My JSP 'mana_CompleteActivity.jsp' starting page</title>
    ...
    <div class="row">
        <div class="col-md-2 leftrow">
            <ul class="nav nav-sidebar">
                ...
                <li><a href="back/mana_ProgressActivity.jsp">正在进行</a></li>
                <li><a href="back/mana_WaitingActivity.jsp">等待揭晓</a></li>
                <li class="active"><a href="back/mana_CompleteActivity.jsp">往期管理</a></li>
                <li><a href="#"></a></li>
                <li><a href="#">设置</a></li>
                <li><a href="#">帮助</a></li>
            </ul>
